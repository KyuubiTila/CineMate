// CLEANING
// cleared all class to className
// closed all tags especially the input tags
// changed fill-rule to fillRule
// changed clip-rule to clipRule
// href changed to "to"
...
export const Header = () => {
  ...
  useEffect(() => {
    ...
    // Adding and removing the class with the darkmode attribute on the web
    darkMode
      ? document.documentElement.classList.add('dark')
      : document.documentElement.classList.remove('dark');
  }, [darkMode]);

  // setting vairables for the active and inactive class for the navbars selection
  const activeClass =
      ...
      <nav className="bg-white border-gray-200 px-2 sm:px-4 py-2.5 dark:bg-gray-900">
        <div className="container flex flex-wrap items-center justify-between mx-auto">
          ...
          <div id="mobile-nav" className="flex md:order-2">
            ...
            <button
              // onclick, reverse the state of darkmode, which will be to false, the current state holder for it's useState is true
            ...
            >
              {/* Ternary condition switch for the dark mode state for its icon */}
              {darkMode ? (
                <svg
                  aria-hidden="true"
                  // sun icon
          ...
          >
            ...
            <ul className="flex flex-col p-4 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
              ...
              <li>
                <NavLink to="movies/popular" className={isNavlinkActive}>
                  Popular
                </NavLink>
              </li>
              <li>
                <NavLink to="movies/top" className={isNavlinkActive}>
                  Top Rated
                </NavLink>
              </li>
              <li>
                <NavLink to="movies/upcoming" className={isNavlinkActive}>
                  Upcoming
                </NavLink>
              </li>
            </ul>
